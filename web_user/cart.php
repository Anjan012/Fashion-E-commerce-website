                            ...
                            if(isset($_SESSION['cart'])&&(count($_SESSION['cart'])>0))
                            {
                                ...
                                foreach($_SESSION['cart'] as $item)
                                {
                                    ...
                                    <tr>
                                        ...
                                        <td class="product-price" data-title="Price"><span class="currency-symbol">Rs. '.number_format($item[3]).'</span></td>
                                        <td class="product-price" data-title="quantity"><span class="currency-symbol">'.$item[4].'</span></td>
                                        <td class="product-subtotal" data-title="Subtotal"><span class="currency-symbol">Rs. '.number_format($total).'</span></td>
                                    </tr>
                                    </tbody>
                                    ';
                                    $total_final +=$total;
                                                        ...
                                                        <table class="table summery-table mb--30">
                                                            <tbody>
                                                                <tr class="order-subtotal">
                                                                    <td>Subtotal</td>
                                                                    <td> Rs. '.number_format($total_final).'</td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Shipping</td>
                                                                    <td>
                                                                        ...
                                                                        <label for="radio2">Local store: Rs. 0</label>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                            <div class="single-payment">
                                                                                <div class="input-group justify-content-between align-items-center">
                                                                                    ...
                                                                                    <label for="radio6">Esewa</label>
                                                                                    <img style="width: 110px; height: 40px;" src="../assets/images/others/esewa.png" alt="Paypal payment">
                                                                                </div>
                                                                            </div>
                                                                            <br>
                                                                ...
                                                                <tr class="order-tax">
                                                                    <td>Tax</td>
                                                                    <td> Rs. '.number_format($tax).'</td>
                                                                </tr>
                                                                <tr class="order-total">
                                                                    <td>Total</td>
                                                                    <td class="order-total-amount"> Rs. '.number_format($total_final + $tax).'</td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                    </div>
